      ...
      <section data-aos="fade-up" className="container py-8 md:py-12">
        <div className="grid grid-cols-1 items-center gap-4 sm:text-ellipsis md:grid-cols-3 md:gap-8">
          <div className=" order-2 flex flex-col items-center gap-4 text-center text-white md:col-span-2  md:items-start md:text-left ">
            <h1 className="text-3xl font-bold ">Boost Your Brand's Visibility</h1>
            <p className="">
              Elevate your brand with strategic marketing. Increase your reach and <br />
              engagement, attract new customers, and strengthen your brand identity. <br />
              Empower Africa  helps to archive it.
            </p>

            <a href="https://www.youtube.com/watch?v=PzhWDSW6yzg" target="blank">
          ...
          <div className="order-1">
            <iframe
              ...
              src="https://www.youtube.com/embed/PzhWDSW6yzg"
